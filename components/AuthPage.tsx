        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/[0.08] bg-[#0b0b14]/80 backdrop-blur-2xl shadow-2xl shadow-black/50">
          ...
          <div className="p-8">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="button"
              className="w-full h-12 flex items-center justify-center gap-3 bg-white/[0.04] border border-white/[0.08] hover:bg-white/[0.08] hover:border-white/[0.12] text-zinc-300 font-semibold text-sm rounded-xl transition-all duration-200"
            >
