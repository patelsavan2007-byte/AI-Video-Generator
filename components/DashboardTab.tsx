...
interface DashboardTabProps {
  ...
  onSelectTemplate: (template: Partial<VideoItem>) => void;
        ...
        {recentVideos.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
            {recentVideos.map((video) => (
              ...
              >
                {/* Visual Thumbnail */}
                <div className="relative aspect-video bg-zinc-950 flex items-center justify-center overflow-hidden cursor-pointer" onClick={() => onPreviewVideo(video)}>
                  <video 
                    src={video.videoUrl} 
